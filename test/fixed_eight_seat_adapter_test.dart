...
void main() {
  ...
  test('maps backend seat zero into a free slot while keeping eight UI seats', () {
    final List<MicSeat> result = adapter.adapt(
    ...
    expect(result.where((MicSeat seat) => seat.backendIndex == 0), hasLength(1));
    expect(
