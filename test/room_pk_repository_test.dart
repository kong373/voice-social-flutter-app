...
void main() {
  test('outgoing room PK invitation becomes a server-authoritative battle', () async {
    final MockRoomPkRepository repository = MockRoomPkRepository();
    final List<RoomPkOpponent> opponents =
        await repository.fetchHotOpponents(roomId: 'room-880217');
    ...
    RoomPkBattle? battle =
        await repository.fetchActiveBattle(roomId: 'room-880217');
    expect(battle, isNotNull);
    expect(battle!.currentSide.roomId, 'room-880217');
    ...
    expect(await repository.fetchHistory(roomId: 'room-880217'), isNotEmpty);
  });

  test('incoming invitation and surrender stay bound to the exact battle', () async {
    final MockRoomPkRepository repository = MockRoomPkRepository();
    final RoomPkInvitation? incoming =
        await repository.fetchIncomingInvitation(roomId: 'room-880217');
