...
void main() {
  test('account compliance mock preserves authoritative account changes', () async {
  ...
  test('account appeal and cancellation validate high-risk submissions', () async {
    final MockAccountComplianceRepository repository =
        MockAccountComplianceRepository();
    ...
    final CancellationEligibility eligibility =
        await repository.queryCancellationEligibility();
