...
class RoomConfigurationForm extends StatelessWidget {
  const RoomConfigurationForm({
    ...
    required this.allowExistingPassword,
  ...
  final bool allowExistingPassword;
    ...
    return Form(
      ...
      child: Column(
        ...
        children: <Widget>[
              ...
              children: <Widget>[
                ...
                if (supportsTopicTitle)
                  ...
                  const RoomOxygenNotice(
                    ...
                    message: '当前 development 后端只持久化一条话题内容，话题标题暂不可用。',
                  ),
                const SizedBox(height: 10),
                TextFormField(
              ...
              children: <Widget>[
                SizedBox(
                  ...
                  child: SegmentedButton<RoomAccessMode>(
                    ...
                    segments: <ButtonSegment<RoomAccessMode>>[
          ...
          const RoomOxygenNotice(
            icon: Icons.info_outline_rounded,
            message: '保存后，房间名称、话题内容与进入方式会按当前后端能力生效。',
          ),
        ],
      ),
    );
