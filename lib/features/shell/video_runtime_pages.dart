...
class VideoRuntimeAccountPage extends StatelessWidget {
  ...
  bool get _showDeveloperDiagnostics =>
      ...
      (dependencies.environment.deploymentEnvironment ==
              DeploymentEnvironment.local ||
          dependencies.environment.deploymentEnvironment ==
              DeploymentEnvironment.development);

  @override
  Widget build(BuildContext context) => PersonalCenterPage(
    session: dependencies.sessionManager.session,
    onSignOut: onSignOut,
    profileRepository: profileRepository,
    isActive: isActive,
    embeddedInShell: true,
    platformEntry: PlatformRoomsEntry(
      key: ObjectKey(dependencies.platformRoomRepository),
      repository: dependencies.platformRoomRepository,
    ),
    footer: !_showDeveloperDiagnostics
        ? null
        : Material(
            color: Colors.transparent,
            child: ListTile(
              ...
              onTap: () => Navigator.of(context).push<void>(
                MaterialPageRoute<void>(
                  builder: (_) => Scaffold(
                    ...
                    body: LiveVendorBoundaryPage(dependencies: dependencies),
                  ),
                ),
              ),
            ),
